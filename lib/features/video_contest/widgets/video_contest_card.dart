...
import '../detail/video_contest_detail_screen.dart';

class VideoContestCard extends StatelessWidget {
  final VideoContest contest;

  const VideoContestCard({super.key, required this.contest});

  void _openDetail(BuildContext context) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => VideoContestDetailScreen(contestId: contest.id),
      ),
    );
  }
